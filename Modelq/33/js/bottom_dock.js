...
$(function() {
  ...
  function dock_big(index) {
    $('#bottom_dock>a>img')
      .eq(index)
      .stop(true, false)
      .animate({ width: '128px', height: '128px' }, 'fast', 'swing');
    $('#bottom_dock')
      .stop(true, false)
      .animate({ left: left - 46 }, 'fast', 'swing');
  }
  function dock_small(index) {
    $('#bottom_dock>a>img')
      .eq(index)
      .stop(true, false)
      .animate({ width: '64px', height: '64px' }, 'fast', 'swing');
    $('#bottom_dock')
      .stop(true, false)
      .animate({ left: left }, 'fast', 'swing');
  }
  function dock_big_lite(index) {
    $('#bottom_dock>a>img')
      .eq(index)
      .stop(true, false)
      .animate({ width: '96px', height: '96px' }, 'fast', 'swing');
  }
});
